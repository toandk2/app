...
//   final listTitles = ['Sửa thông tin cá nhân', 'Sửa thông tin hộ kinh doanh'];
//   final updateInfoUrl = [
...
//       initBuyerAddresses = await _getBuyerAddress();
//     }
...
//       final newAddress =
//           List<AddressModel>.filled(3 - addresses.length, AddressModel());
...
//         body['xeom_address'] = _user?.address ?? '';
//         body['xeom_location'] = _user?.address ?? '';
//       }
//       try {
...
//                 ),
//                 if (Configs.userGroup == 0)
//                   _BuyerWidget(addresses: initBuyerAddresses),
//                 const SizedBox(
//                   height: 20,
//                 ),
//                 if (Configs.userGroup == 1)
...
//                   ),
//                 if (Configs.userGroup == 1)
//                   const Text('Tên cửa hàng/thương hiệu',
